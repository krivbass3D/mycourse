...
function xmldb_block_mycourse_upgrade($oldversion = 0): bool {
    ...
    if ($oldversion < 2021120702) {
        ...
        $table = new xmldb_table('block_mycourse_savestate');
        ...
        upgrade_plugin_savepoint(true, 2021120702, 'block', 'mycourse');
    }
