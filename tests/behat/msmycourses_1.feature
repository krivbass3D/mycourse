...
#      | forum    | C1     | forum1   | Test forum name | Test forum description | 1          | 0              |
#   Then I should see "Enable" in the "Display H5P filter" "table_row"
#    And I click on "Category A" "text"
#    And I click on "[data-id=194001]" "css_element"
...
#    asdfasfdsdfsdfsdfsdfds mo
  ...
  Scenario: Set Title and Course Title. Disable summary. Display.
    ...
    And I should see "Test course 1" in the "Courses" "block"
